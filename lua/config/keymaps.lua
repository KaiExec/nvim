...
keymap.set("n", "<C-S-i>", [[<cmd>vertical resize +5<cr>]]) -- make the window biger vertically
keymap.set("n", "<C-S-k>", [[<cmd>vertical resize -5<cr>]]) -- make the window smaller vertically
